...
**Biological question**  
What biological processes are over-represented among the genes that clearly change with treatment?

**Input**  
A thresholded DEG list using `padj < 0.05` and `|log2FoldChange| >= 1`.

**Core method**  
Over-representation analysis (ORA) on up- and down-regulated genes separately.
...
In this dataset, ORA highlights the biological themes that stand out once we draw a hard line around the DE genes. That is useful, but it still throws away the graded information in the full ranked result.
